...
namespace Juzaweb\FileManager\Facades;

use Illuminate\Http\UploadedFile;
use Illuminate\Support\Facades\Facade;
use Intervention\Image\Image;
use Juzaweb\FileManager\Models\Media as MediaModel;
 ...
 * @see \Juzaweb\FileManager\Contracts\Media
 */
class Media extends Facade
{
    protected static function getFacadeAccessor(): string
    {
        return \Juzaweb\FileManager\Contracts\Media::class;
    }
}
